...
fn main() {
    ...
    // Espressão regular para encontrar datas no formato YYYY-MM-DD
    ...
    for line in reader.lines() {
        ...
        // Substitua as datas no formato YYYY-MM-DD pelo formato DD-MM-YYYY
        ...
        // Escreva a linha modificada no arquivo de saida
